...
def loaddata(what):
    ...
    x_train,x_test,y_train,y_test = train_test_split(x,y,test_size = 0,random_state = 41)
...
if __name__ == "__main__":
    ...
    if(what == '1P'):
        ...
        filename = "C:\\Users\\fghj8\\MLGame-master\\games\\pingpong\\my_tree_1P_new.sav"
    else:
        my_tree = build_tree(loaddata('2P'))   
        filename = "C:\\Users\\fghj8\\MLGame-master\\games\\pingpong\\my_tree_2P_new.sav"
